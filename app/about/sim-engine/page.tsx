...
rng = np.random.default_rng(date_seed)`}</code>
      ...
      <section className="space-y-4" id="commands">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm">
          ...
          <li>
            <code className="bg-muted px-1 rounded">cmd_backfill</code> — contiguous historical
            range with no t-365 paired generation. The range is anchored with one of{" "}
      ...
      <section className="space-y-4" id="code-organization">
        ...
        <ul className="list-disc list-inside space-y-1 text-sm">
          ...
          <li>
            <code className="bg-muted px-1 rounded">date_resolver.py</code> — eight-date resolver
            for <code className="bg-muted px-1 rounded">cmd_run</code> (anchor plus the six
            trailing days plus the calendar-matched date one year prior)
          </li>
          <li>
