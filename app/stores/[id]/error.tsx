...
export default function StoreError({
  ...
  useEffect(() => {
    console.error("[stores/[id] error] server component render failed", {
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-16 text-center space-y-4">
      ...
      <p className="text-muted-foreground">
        The store drilldown hit an error while fetching metrics. Try again, or
        return to the store index.
      </p>
      {error.digest ? (
